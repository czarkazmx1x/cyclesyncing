-- ============================================
-- CYCLESYNC COMPLETE DATABASE SETUP
-- ============================================
-- Run this entire script to set up a clean database structure

-- First, drop existing tables if they exist (be careful - this deletes data!)
...
DROP TABLE IF EXISTS public.user_dashboard_data CASCADE;
...
-- (These will be inserted with a placeholder user_id - you can update this later)
